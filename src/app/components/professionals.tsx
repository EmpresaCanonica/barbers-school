...
export function Professionals() {
  return (
    <div className='w-full md:h-[64rem] h-full bg-img_bg_professionals bg-cover justify-center flex items-center my-auto' id="team">
                ...
                <div className='flex flex-wrap justify-between w-full gap-y-4'>
                    ...
                    <div className="relative group">
                        <a href='#' >
                                ...
                                <div className="absolute rounded-xl inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    ...
                                    <span className="text-white md:text-lg text-sm">@BrunoBarber</span>
                                </div>
                        </a>
                    </div>
                    ...
                    <div className="relative group">
                        <a href='#' >
                                ...
                                <div className="absolute rounded-xl inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <img src="/assets/instagram-icon2.png" alt="https://br.freepik.com/psd-gratuitas/logotipo-da-aplicacao-instagram_206467801.htm" className="w-[3rem] h-[3rem] mb-2" />
                                    <span className="text-white md:text-lg text-sm">@MarcosBarber</span>
                                </div>
                        </a>
                    </div>
                    ...
                    <div className="relative group">
                        <a href='#' >
                                ...
                                <div className="absolute rounded-xl inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <img src="/assets/instagram-icon2.png" alt="https://br.freepik.com/psd-gratuitas/logotipo-da-aplicacao-instagram_206467801.htm" className="w-[3rem] h-[3rem] mb-2" />
                                    <span className="text-white md:text-lg text-sm">@PabloBarber</span>
                                </div>
                        </a>
                    </div>
                    ...
                    <div className="relative group">
                        <a href='#' >
                                ...
                                <div className="absolute rounded-xl inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <img src="/assets/instagram-icon2.png" alt="https://br.freepik.com/psd-gratuitas/logotipo-da-aplicacao-instagram_206467801.htm" className="w-[3rem] h-[3rem] mb-2" />
                                    <span className="text-white md:text-lg text-sm">@FranciscoBarber</span>
                                </div>
                        </a>
                    </div>
